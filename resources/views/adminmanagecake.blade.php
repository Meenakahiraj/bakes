...
<tr>
    <td>Product Name</td>
    <td><input type="text" class="formcontrol" name="pname" value="{{ $cake->pname }}"></td>
</tr>
<tr>
    <td>Cost</td>
    <td><input type="text" class="formcontrol" name="pcost" value="{{ $cake->pcost }}"></td>
</tr>
<tr>
    <td>Description</td>
    <td><input type="text" class="formcontrol" name="pdesc" value="{{ $cake->pdesc }}"></td>
</tr>
<tr>
    <td></td>
